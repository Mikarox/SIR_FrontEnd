...
import miscellaneusRoutes from './routes/miscellaneousRoutes';
...
class MyServer{
  ...
  routes(): void{
    ...
    this.app.use('/api/', miscellaneusRoutes) //ruta de eentos generales
    this.app.use('/api/users',usersRoutes) //ruta para trabajar con la tabla usrs de la base de datos
    this.app.use('/api/personal',personalRoutes) //ruta para trabajar con la tabla persoanl de la base de datos
    this.app.use('/api/vehiculos',vehiculosRoutes) //ruta para trabajar con vehiculos de la base de datos
    this.app.use('/api/licencias',licenciasRoutes) //ruta para trabajar con vehiculos de la base de datos
  }
