...
const miscellaneousRoutes_1 = __importDefault(require("./routes/miscellaneousRoutes"));
...
class MyServer {
    ...
    routes() {
        ...
        this.app.use('/api/', miscellaneousRoutes_1.default); //ruta de eentos generales
        this.app.use('/api/users', usersRoutes_1.default); //ruta para trabajar con la tabla usrs de la base de datos
        this.app.use('/api/personal', personalRoutes_1.default); //ruta para trabajar con la tabla persoanl de la base de datos
        this.app.use('/api/vehiculos', vehiculosRoutes_1.default); //ruta para trabajar con vehiculos de la base de datos
        this.app.use('/api/licencias', licenciasRoutes_1.default); //ruta para trabajar con vehiculos de la base de datos
    }
    start() {
