...
class UserController {
    ...
    register(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            //creacion de fecha de nacimiento para usar a continuacion la
            yield database_1.default.query('INSERT INTO `users` (`id_user`, `email`, `password`, `admin`, `nombres`, `A_paterno`, `A_materno`, `FK_Fecha_Birthday`) VALUES (NULL, ?, ?, ?, ?, ?, ?, NULL)', [req.body.email, req.body.password, req.body.admin, req.body.nombres, req.body.A_paterno, req.body.A_materno], function (err, result, fields) {
                return __awaiter(this, void 0, void 0, function* () {
                    if (err)
                        throw err;
                    yield database_1.default.query('SELECT * FROM users WHERE email = ? ', [req.body.email], function (err, result, fields) {
                        return __awaiter(this, void 0, void 0, function* () {
                            if (err)
                                throw err;
                            yield database_1.default.query('INSERT INTO `birthday` (`ID_Birthday`, `Fecha`, `FK_User`, `FK_Personal`) VALUES (NULL,?,?, NULL) ', [req.body.birthday, result[0].id_user], function (err, result, fields) {
                                return __awaiter(this, void 0, void 0, function* () {
                                    if (err)
                                        throw err;
                                    yield database_1.default.query('UPDATE `users` SET `FK_Fecha_Birthday` = ? WHERE id_user=(SELECT FK_User FROM `birthday` where ID_Birthday =?)', [result.insertId, result.insertId], function (err, result, fields) {
                                        return __awaiter(this, void 0, void 0, function* () {
                                            if (err)
                                                throw err;
                                            yield database_1.default.query('SELECT * FROM users WHERE email = ? ', [req.body.email], function (err, result, fields) {
    ...
    login(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield database_1.default.query('SELECT * FROM users WHERE email = ? UNION SELECT * FROM users WHERE nick = ?', [req.body.email, req.body.email], function (err, result, fields) {
                if (err)
                    throw err;
                if (result.length == 1) {
    ...
    isExistEmial(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield database_1.default.query('SELECT * FROM users WHERE email = ? UNION SELECT * FROM users WHERE nick = ?', [email, email], function (err, result, fields) {
                if (err)
                    throw err;
                if (result.length > 0) {
