...
@Component({
  ...
  templateUrl: './edit-licencia.component.html',
  styleUrls: ['./edit-licencia.component.css']
})
    ...
    this.licenciaService.getLicenciaOne(this.id)
      .subscribe({
        next: (r) => {
          ...
          this.form.controls['Categoria'].setValue(this.allLicence.categoria);
          console.log(this.allLicence.tipo);
          this.titulo = this.allLicence.categoria;
          this.form.controls['Institucion'].setValue(this.allLicence.Institucion);
          this.form.controls['Detalles'].setValue(this.allLicence.detalles);
          this.form.controls['Fecha'].setValue(formatDate(this.allLicence.FechaAdquirida, 'yyyy-MM-dd', 'en_US'));
          this.Fecha = formatDate(this.allLicence.FechaAdquirida, 'yyyy-MM-dd', 'en_US');
          this.typeFecha = this.allLicence.tipo;
          this.form.controls['Tipo'].setValue(this.allLicence.tipo);
          this.cantidadfecha = this.allLicence.cantidad;
          this.form.controls['Cantidad'].setValue(this.allLicence.cantidad);
          this.form.controls['Vencimiento'].setValue(formatDate(this.allLicence.Fecha, 'yyyy-MM-dd', 'en_US'));
